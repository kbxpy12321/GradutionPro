...
//	Matrix *hh = MatrixCalculation::algorithmDNS(aa, bb, 8);
//	ends = clock();
...
//	Matrix *dd = MatrixCalculation::algorithmStrassen(aa, bb, 0);
//	ends = clock();
...
//	Matrix *gg = MatrixCalculation::algorithmStrassen(aa, bb, 8);
//	ends = clock();
...
//	Matrix *ee = MatrixCalculation::algorithmCannon(aa, bb, 9);
//	ends = clock();
